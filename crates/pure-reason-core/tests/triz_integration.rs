...
mod triz_integration_tests {
    ...
    fn test_pre_verifier_integration() {
        ...
        println!("Arithmetic test: verdict={:?}, confidence={}", result.verdict, result.confidence);
        ...
        assert!(complex.complexity > simple.complexity, "Complex text should have higher complexity score");
    }
    ...
    fn test_domain_calibrator_general_fallback() {
        ...
        let detected = calibrator.detect_domain("random text without domain markers").unwrap();
    ...
    fn test_end_to_end_triz_stack() {
        ...
        println!("Pre-verification: complexity={}, can_short_circuit={}", 
        ...
        println!("Domain detected: {} (confidence={})", domain.name, domain.confidence);
        ...
        println!("Meta-learner: call_count={}, is_warmup={}", 
                 learner.call_count(), learner.is_warmup());
